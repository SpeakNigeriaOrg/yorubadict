  ...
  function connectionsHtml() {
    return `
      <div class="about-content">
        ...
        <h3>What order would you teach in?</h3>
        <p>Most beginners' courses teach the body early, and they are right to. It is concrete, you can point at it, and a class can practise it on each other. That is the usual reason and it is a reason about teaching rather than about Yorùbá.</p>
        ...
        <p>Judged by what is built <em>on</em> it, it is the most valuable week in the course. Around seventy words elsewhere have a body part inside and are not about bodies, and three body words sit in this dictionary's twenty-five most productive: <em>ojú</em> builds forty-seven words, <em>orí</em> thirty-four, <em>ara</em> thirty-three.</p>
        ...
        <p>This is not nine words that happen to share a part. It is one idea with nine examples, and the idea is not a metaphor. Yorùbá puts what you feel in the belly and what you are in the face, and it says so in the words themselves. A class that met <em>inú</em> and <em>ojú</em> in week one does not have to be told any of this. They see it coming, and the second unit costs a fraction of the first.</p>
        ...
        <p>If you teach Yorùbá, you are better placed to answer them than we are. The dictionary is here to be argued with.</p>
