  ...
  function renderAbout() {
    els.entryContent.innerHTML = `
      <div class="about-content">
        ...
        <p>We can build a deep, comprehensive and GROWING dictionary through the use of Wiktionary. We hope to not only make it easier to navigate, but encourage people to contribute. If you can't find a word in our dictionary, add it to Wiktionary! Beyond that, the  Yorùbá speakers who contribute to Wiktionary know that the language is fundamentally different from English in how it builds larger words out of smaller building-block words. People often think of etymology as an academic curiosity, but in languages like Yorùbá being able to recognize compound words is part of fluency. It's also fun. One of the things students in our own classes love most about the language are learning how words combine to create new words. Wiktionary is not comprehensive in these breakdowns, but it's a better source for them than anywhere else online. We make it easier to find and explore these links.</p>
